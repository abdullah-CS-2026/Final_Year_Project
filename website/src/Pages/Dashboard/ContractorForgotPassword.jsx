...
export const ContractorForgotPassword = () => {
  ...
  const handleSendOTP = async (e) => {
    ...
    const res = await fetch(`${BASE_URL}/contractor/forgot-password`, {
      method: "POST",
  ...
  const handleVerifyOTP = async (e) => {
    ...
    const res = await fetch(`${BASE_URL}/contractor/verify-otp`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const handleResetPassword = async (e) => {
    ...
    const res = await fetch(`${BASE_URL}/contractor/reset-password`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
